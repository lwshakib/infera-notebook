...
export const CustomTextLogo = ({
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      <span className={cn('font-bold tracking-tight text-foreground', currentSize.brand)}>
        <span className="font-extrabold">In</span>
        <span className="font-semibold">fera</span>
      </span>
      {showNotebook && (
        <>
          <span
            className={cn(
              'w-px',
              currentSize.divider,
              resolvedTheme === 'dark' ? 'bg-muted-foreground/30' : 'bg-muted-foreground/30'
            )}
          />
          <span
            className={cn(
              'font-medium tracking-widest uppercase',
              currentSize.notebook,
              resolvedTheme === 'dark' ? 'text-muted-foreground/60' : 'text-muted-foreground/60'
            )}
          >
            Notebook
          </span>
