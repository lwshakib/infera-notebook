...
/**
 * Custom hook to interface with ElevenLabs Scribe for real-time transcription.
 *
 * @param options - Configuration including callbacks for transcripts and errors.
 * @returns State and methods to manage the transcription session.
 */
export function useScribe(options: ScribeHookOptions = {}): UseScribeReturn {
  ...
  /**
   * Gracefully closes the active transcription connection and cleans up references.
   */
  ...
  /**
   * Establishes a new connection to the ElevenLabs Scribe service.
   * Supports both 'microphone' and 'manual' audio modes.
   *
   * @param runtimeOptions - Override options for this specific connection.
   */
